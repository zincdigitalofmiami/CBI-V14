...
|-----------|--------|----------------|-----------|-------|
| **Futures OHLCV** | DataBento | 14 core | 5min/1hr | `market_data.databento_futures_ohlcv_1m` |
...
| **Alpha Insider** | Alpha Vantage | 8+ stocks | Daily | `raw_intelligence.alpha_insider_transactions` |
| **Alpha Analytics** | Alpha Vantage | Fixed + sliding | Daily | `raw_intelligence.alpha_analytics` |
