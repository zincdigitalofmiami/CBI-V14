...
// closeMappedFile ensures that the given mapped file is closed. On Windows, this is
// necessary prior to test cleanup.
func closeMappedFile(f *file) {
	mf := f.current.Load()
	if mf == nil {
