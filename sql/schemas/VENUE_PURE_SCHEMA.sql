...
-- Strategy: Use CME-native crush/oilshare for substitution economics (CVOL discontinued)
-- ============================================================================
...
-- ============================================================================
-- PART 2: CME INDICES (COSI) - Via ScrapeCreator EOD
-- ============================================================================

-- Table 6: CME Indices EOD (Oilshare Only)
CREATE OR REPLACE TABLE market_data.cme_indices_eod (
  date DATE NOT NULL,
  index_type STRING NOT NULL,       -- COSI
  product STRING NOT NULL,          -- COSI1, COSI2, ..., COSI9
...
OPTIONS (
  description='CME Soybean Oilshare Index (COSI1-9) via ScrapeCreator - CVOL discontinued'
);
...
-- Table 19: Volatility Daily (Realized + VIX; CVOL discontinued)
...
PARTITION BY date
OPTIONS (
  description='Volatility layer - realized from DataBento + FRED VIX (CVOL discontinued)'
);
...
CREATE OR REPLACE TABLE signals.big_eight_live (
  ...
  big8_vix_stress FLOAT64,                  -- From volatility_daily (VIX)
