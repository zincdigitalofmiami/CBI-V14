...
OPTIONS (description='CME Soybean Oilshare Index (COSI1-9) via ScrapeCreator - CVOL discontinued');
...
-- Table 17: Volatility Daily (No CVOL)
...
PARTITION BY date
OPTIONS (description='Volatility layer - realized from DataBento + FRED VIX (CVOL discontinued)');
