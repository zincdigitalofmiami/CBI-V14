                        ...
                        for article in articles:
                            ...
                            if any(keyword in text for keyword in trump_ag_keywords):
                                trump_intel.append({
                                    ...
                                    'agricultural_impact': self._assess_policy_impact(text),
                                    'soybean_relevance': self._assess_commodity_relevance(text),
                                    'timestamp': datetime.now(),
                                    'priority': source['priority']
                                })
...
def main():
    ...
    print("Using surgical fix with existing save function")
    print("=" * 60)
    ...
    print("✅ ICE & Trump intelligence collection completed")
