...
### Horizon Registry (Active vs. Research)
- Active (production focus)
  - ZL daily: 1w, 1m, 3m, 6m, 12m
  - MES intraday (special): 5m, 15m, 60m
  - MES multi-day (main): 1d, 7d, 30d
- Research/Special tracks (gated by validation)
  - MES intraday: 1m, 30m, 4h
  - MES multi-day: 3m, 6m, 12m
  - Notes: research horizons are trained/evaluated off the same surfaces; promotion requires sustained lift and calibration.

Machine-readable registry for scripts: `config/horizon_registry.yaml`
