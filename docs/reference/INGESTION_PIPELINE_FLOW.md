...
## Step 3: Export to External Drive (Manual)
...
External Drive: TrainingData/exports/
...
**Status:** ❌ **NOT AUTOMATED** - Must run manually

---

## Step 4: Local Training (Manual)

```
External Drive: TrainingData/exports/*.parquet
  
  ↓ (Manual: python3 src/training/*.py)
  
Mac M4 Local Training
  ├── Train models with TensorFlow Metal
  └── Save to Models/local/ and Models/vertex-ai/
```

**Status:** ❌ **NOT AUTOMATED** - Manual training execution
