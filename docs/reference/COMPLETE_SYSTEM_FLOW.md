...
# CBI-V14 Complete System Flow
**Last Updated**: November 12, 2025  
**Purpose**: Complete end-to-end data flow documentation from ingestion to web display

---

## 📊 System Overview

CBI-V14 is a soybean oil (ZL) futures forecasting platform with two production tracks:
1. **BQML Production Models** (Active) - 5 horizons (1w, 1m, 3m, 6m, 12m)
2. **Vertex AI Neural Pipeline** (In Progress) - Local training on M4 Mac → Cloud deployment
...
- **Yahoo Finance** (`yfinance` library) - Price data for 12+ commodities
...
- **Yahoo Finance Historical** - 25+ years (2000-2025), 314,381 rows
...
**Primary Warehouse**: `cbi-v14.forecasting_data_warehouse.*`
...
├── yahoo_normalized            # 314,381 rows (2000-2025)
...
6. **Save to BigQuery**: `cbi-v14.predictions.daily_forecasts`
