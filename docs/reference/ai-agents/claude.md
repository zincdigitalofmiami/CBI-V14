# CBI‑V14 – Project Manual for AI Assistants

This file tells AI models how to work in this repo without breaking the architecture or multiplying plans. Treat it as the project manual.
