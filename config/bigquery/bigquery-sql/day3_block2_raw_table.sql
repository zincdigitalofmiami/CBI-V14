...
-- 🏗️ BLOCK 2: Raw Daily Table
-- Purpose: The canonical storage for Databento Daily data. Constraints: Partitioned by Date, Clustered by Symbol.
...
CREATE TABLE IF NOT EXISTS `cbi-v14.market_data.databento_futures_ohlcv_1d` (
  ...
  close FLOAT64,
  volume INT64,
  settle FLOAT64,       -- Critical for Futures
  vwap FLOAT64,
  open_interest INT64,
