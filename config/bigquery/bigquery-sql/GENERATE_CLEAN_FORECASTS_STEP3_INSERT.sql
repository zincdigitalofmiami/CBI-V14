...
-- ============================================
-- STEP 3: INSERT FORECASTS INTO TABLE
-- ============================================
-- Run this after generating forecasts
...
forecast_1w AS (
  SELECT 
    ...
    CAST(NULL AS FLOAT64) as crisis_intensity_score,
    CAST(NULL AS STRING) as primary_signal_driver,
    CAST(NULL AS FLOAT64) as composite_signal_score,
    CAST(NULL AS FLOAT64) as palm_sub_risk,
