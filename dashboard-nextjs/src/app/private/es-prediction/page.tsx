...
import { TrendingUp, TrendingDown, Target, Shield, AlertTriangle, BarChart3, Activity } from 'lucide-react'
                        ...
                        {Object.entries(esPrediction.model_predictions).map(([model, prediction]) => (
                          <div key={model} className="text-center">
                            ...
                            <p className={`text-lg font-semibold ${
                              prediction.includes('+') ? 'text-green-500' : 
                    ...
                    <div className="space-y-3">
                      {esPrediction.trading_signals.map((signal, i) => (
                        <div key={i} className={`p-3 rounded-lg ${
                          signal.includes('BUY') ? 'bg-green-500/10 border border-green-500/20' :
